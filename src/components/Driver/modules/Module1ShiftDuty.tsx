      ...
      <div className="bg-card border border-border p-4 rounded-md">
          ...
          <div className="grid grid-cols-3 sm:grid-cols-5 gap-1.5 font-mono text-xs">
            {[
              ...
              <button
                ...
                className={`py-1.5 px-2 rounded-sm text-center transition-all cursor-pointer border text-[11px] font-medium active:scale-[0.98] ${
        ...
        <div className="pt-2 border-t border-border flex items-center justify-between">
          ...
          <button
            ...
            className="px-2.5 py-1 bg-secondary hover:bg-accent text-foreground rounded-sm border border-border text-xs font-mono font-medium flex items-center gap-1.5 transition-colors cursor-pointer active:scale-[0.98]"
          >
        ...
        {/* QR Code Expansion */}
        {showQrModal && (
          <div className="mt-3 p-3 bg-secondary/50 border border-border rounded-sm flex flex-col items-center text-center space-y-2">
            <div className="w-24 h-24 bg-card border border-foreground rounded-sm flex items-center justify-center font-mono text-xs">
            ...
            <button
              ...
              className="px-3 py-1.5 bg-foreground text-background font-mono text-xs font-medium rounded-sm cursor-pointer active:scale-[0.98]"
            >
